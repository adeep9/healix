...
const Sidebar = () => {
    ...
    return (
        <div className="fixed top-0 left-0 h-screen w-64 bg- p-4 shadow-lg flex flex-col">
        <div className="mb-8">
          <div className="h-12 w-full bg-gray-300 flex items-center justify-center rounded">
